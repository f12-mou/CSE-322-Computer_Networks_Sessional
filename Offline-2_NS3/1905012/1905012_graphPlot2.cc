...
int speedsArr[6] = {0, 5, 10, 15, 20, 25};
...
main(int argc, char* argv[])
{
    ...
    std::string fileNameWithNoExtension = "dynamic-nodes-throughput";
    std::string graphicsFileName = fileNameWithNoExtension + ".png";
    std::string plotFileName = fileNameWithNoExtension + ".plt";
    std::string plotTitle = "dynamic nodes varying Throughput";
    ...
    for (int i = 1; i <= 5; i++)
    {
        ...
        std::string thFile = "./dynamic/nodes/thFile" + std::to_string(i) + ".txt";
    ...
    // dynamic MODEL
    // NODES COUNT -> RATIO
    std::string fileNameWithNoExtension2 = "dynamic-nodes-ratio";
    std::string graphicsFileName2 = fileNameWithNoExtension2 + ".png";
    std::string plotFileName2 = fileNameWithNoExtension2 + ".plt";
    std::string plotTitle2 = "dynamic nodes varying Packet Ratio";
    ...
    for (int i = 1; i <= 5; i++)
    {
        ...
        std::string thFile2 = "./dynamic/nodes/ratioFile" + std::to_string(i) + ".txt";
    ...
    // dynamic MODEL
    // FLOWS -> THROUGHPUT
    std::string fileNameWithNoExtension3 = "dynamic-flows-throughput";
    std::string graphicsFileName3 = fileNameWithNoExtension3 + ".png";
    std::string plotFileName3 = fileNameWithNoExtension3 + ".plt";
    std::string plotTitle3 = "dynamic - Throughput - varying flows";
    ...
    for (int i = 1; i <= 5; i++)
    {
        ...
        std::string thFile = "./dynamic/flows/thFile" + std::to_string(i) + ".txt";
        freopen(thFile.c_str(), "r", stdin);
        for (x = startVal; x <= endVal; x += inc)
        {
            std::cin >> y;
    ...
    // dynamic MODEL
    // FLOWS -> RATIO
    std::string fileNameWithNoExtension4 = "dynamic-flows-ratio";
    std::string graphicsFileName4 = fileNameWithNoExtension4 + ".png";
    std::string plotFileName4 = fileNameWithNoExtension4 + ".plt";
    std::string plotTitle4 = "dynamic - Packet Ratio - varying flows";
    ...
    for (int i = 1; i <= 5; i++)
    {
        ...
        std::string thFile4 = "./dynamic/flows/ratioFile" + std::to_string(i) + ".txt";
    ...
    // dynamic MODEL
    // PPERS -> THROUGHPUT
    std::string fileNameWithNoExtension5 = "dynamic-ppers-throughput";
    std::string graphicsFileName5 = fileNameWithNoExtension5 + ".png";
    std::string plotFileName5 = fileNameWithNoExtension5 + ".plt";
    std::string plotTitle5 = "dynamic - Throughput - varying - ppers";
    ...
    for (int i = 1; i <= 5; i++)
    {
        ...
        std::string thFile = "./dynamic/ppers/thFile" + std::to_string(i) + ".txt";
        freopen(thFile.c_str(), "r", stdin);
        for (x = startVal; x <= endVal; x += inc)
        {
            std::cin >> y;
    ...
    // dynamic MODEL
    // PPERS -> RATIO
    std::string fileNameWithNoExtension6 = "dynamic-ppers-ratio";
    std::string graphicsFileName6 = fileNameWithNoExtension6 + ".png";
    std::string plotFileName6 = fileNameWithNoExtension6 + ".plt";
    std::string plotTitle6 = "dynamic - Packet Ratio - varying flows";
    ...
    for (int i = 1; i <= 5; i++)
    {
        ...
        std::string thFile6 = "./dynamic/ppers/ratioFile" + std::to_string(i) + ".txt";
    ...
    // dynamic MODEL
    // speeds -> THROUGHPUT
    std::string fileNameWithNoExtension7 = "dynamic-speeds-throughput";
    std::string graphicsFileName7 = fileNameWithNoExtension7 + ".png";
    std::string plotFileName7 = fileNameWithNoExtension7 + ".plt";
    std::string plotTitle7 = "dynamic - Throughput - varying -speeds";
    ...
    for (int i = 1; i <= 5; i++)
    {
        dataset7[i].SetTitle("speeds Count - " + std::to_string(speedsArr[i]));
        dataset7[i].SetStyle(Gnuplot2dDataset::LINES_POINTS);
        std::string thFile = "./dynamic/speeds/thFile" + std::to_string(i) + ".txt";
        freopen(thFile.c_str(), "r", stdin);
        for (x = startVal; x <= endVal; x += inc)
        {
            std::cin >> y;
    ...
    // dynamic MODEL
    // speeds -> RATIO
    std::string fileNameWithNoExtension8 = "dynamic-speeds-ratio";
    std::string graphicsFileName8 = fileNameWithNoExtension8 + ".png";
    std::string plotFileName8 = fileNameWithNoExtension8 + ".plt";
    std::string plotTitle8 = "dynamic - Packet Ratio - varying speeds";
    ...
    for (int i = 1; i <= 5; i++)
    {
        dataset8[i].SetTitle("Range Count - " + std::to_string(speedsArr[i]));
        dataset8[i].SetStyle(Gnuplot2dDataset::LINES_POINTS);
        std::string thFile8 = "./dynamic/speeds/ratioFile" + std::to_string(i) + ".txt";
